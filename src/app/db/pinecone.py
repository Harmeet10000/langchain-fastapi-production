...
class VectorStoreService:
    ...
    async def similarity_search_with_relevance_scores(
        ...
        try:
            ...
            logger.info(
                f"Filtered to {len(filtered_results)} results above threshold {score_threshold}"
            )
    ...
    async def delete_by_ids(self, ids: List[str], namespace: str = "default") -> bool:
    ...
    async def delete_by_metadata(
        self, metadata_filter: Dict[str, Any], namespace: str = "default"
    ) -> bool:
        ...
        try:
            ...
            pinecone_index.delete(filter=metadata_filter, namespace=namespace)

            logger.info(
                f"Deleted vectors with filter {metadata_filter} from namespace {namespace}"
            )
            return True
    ...
    async def update_metadata(
        ...
        try:
            ...
            pinecone_index.update(id=id, set_metadata=metadata, namespace=namespace)
