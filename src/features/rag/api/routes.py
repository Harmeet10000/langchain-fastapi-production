...
from features.rag.api.schemas import (
    RAGQuery, RAGResponse, DocumentUploadResponse, VectorSearchResponse, 
    VectorStatsResponse, VectorDeleteRequest
)
...
from shared.schemas.response import http_success, http_error, http_created
...
async def delete_vectors(
    ...
    try:
        result = await service.delete_vectors(delete_request.ids, delete_request.namespace)
