...
from features.crawl.api.schemas import (
    CrawlRequest, SmartCrawlRequest, CrawlStatus, CrawlResult,
    SmartCrawlResponse, UrlExtractionRequest, UrlExtractionResponse,
    SitemapResponse, CrawlJobCancelResponse
)
from features.crawl.repositories.crawl_repository import CrawlRepository, get_crawl_repository
...
from services.web_intelligence.smart_scraper import smart_scraper
...
class CrawlService:
    ...
    async def crawl_website(
        ...
        try:
            ...
            background_tasks.add_task(
                self._crawl_website_background,
                job_id,
                crawl_request
            )
    ...
    async def _crawl_website_background(self, job_id: str, request: CrawlRequest):
        ...
        try:
            ...
            await self.crawl_repo.update_crawl_status(job_id, "failed", error_message=str(e))
        ...
        try:
            ...
            if not job_status:
                ...
                job_status = {
                    ...
                    "end_time": job_data.get("updated_at", {}).isoformat() if job_data.get("updated_at") else None,
    ...
    async def get_crawl_results(self, job_id: str, limit: int = 100) -> List[CrawlResult]:
    ...
    async def extract_from_url(self, request: UrlExtractionRequest) -> UrlExtractionResponse:
