...
from features.documents.services.document_service import (
    DocumentService,
...
async def upload_document(
    ...
    try:
        ...
        result = await service.upload_document(
            file=file, upload_request=upload_request, background_tasks=background_tasks
        )

        return http_success(
            request, message="Document uploaded successfully", data=result
        )
...
async def get_document_status(
    ...
    try:
        ...
        if not result:
            return http_error(request, Exception("Document not found"), status_code=404)

        return http_success(
            request, message="Document status retrieved successfully", data=result
        )
...
async def list_documents(
    ...
    try:
        ...
        return http_success(
            request, message="Documents listed successfully", data=result
        )
...
async def process_document(
    ...
    try:
        ...
        return http_success(request, message="Document processing started", data=result)
...
async def search_documents(
    ...
    try:
        ...
        return http_success(
            request, message="Document search completed successfully", data=result
        )
...
async def delete_document(
    ...
    try:
        ...
        return http_success(
            request, message=f"Document {document_id} deleted successfully", data=result
        )
...
async def extract_entities(
    ...
    try:
        ...
        return http_success(
            request, message="Entities extracted successfully", data=result
        )
